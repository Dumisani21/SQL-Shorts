...
# DB.sql_insert_data('customer',('Bob','Doe','JamesD@email.com',4123021391))

# DB.sql_udate_data('customer',"email = 'MaxS@email.com'",1)

# DB.sql_delete_data('customer',2)

# DB.sql_drop_table('customer')

# print(DB.sql_view_all('customer'))

# print(DB.sql_view_specific('customer','fname, email'))
